...
import (
	...
	"github.com/kzmake/nifcloud-sdk-go/private/model/api"
	"github.com/kzmake/nifcloud-sdk-go/private/util"
)
...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/kzmake/nifcloud-sdk-go/service", "namespace to generate service client Go code import path under")
	flag.Parse()
	api.Bootstrap()
