...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/kzmake/nifcloud-sdk-go/nifcloud": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/awsutil"] = true
	a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/request"] = true
	if a.OperationHasOutputPlaceholder() {
		a.imports["github.com/kzmake/nifcloud-sdk-go/private/protocol/"+a.ProtocolPackage()] = true
		a.imports["github.com/kzmake/nifcloud-sdk-go/private/protocol"] = true
	}

	for _, op := range a.Operations {
		if op.AuthType == "none" {
			a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/credentials"] = true
			break
		}
	}
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/client"] = true
	a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/client/metadata"] = true
	a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/request"] = true
	if a.Metadata.SignatureVersion == "v2" {
		a.imports["github.com/kzmake/nifcloud-sdk-go/private/signer/v2"] = true
		a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/corehandlers"] = true
	} else if a.Metadata.SignatureVersion == "v2-computing" {
		a.imports["github.com/kzmake/nifcloud-sdk-go/private/signer/v2computing"] = true
		a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/corehandlers"] = true
	} else {
		a.imports["github.com/kzmake/nifcloud-sdk-go/nifcloud/signer/v4"] = true
	}
	a.imports["github.com/kzmake/nifcloud-sdk-go/private/protocol/"+a.ProtocolPackage()] = true
...
func (a *API) InterfaceGoCode() string {
	...
	a.imports = map[string]bool{
		"github.com/kzmake/nifcloud-sdk-go/nifcloud":         true,
		"github.com/kzmake/nifcloud-sdk-go/nifcloud/request": true,
